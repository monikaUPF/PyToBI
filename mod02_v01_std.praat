...
clearinfo
form Parameters
	text directory /home/upf/modularProsodyTagger/test/
	text basename spk1f_007
endform

Read from file: directory$ + basename$ + "_mod1.TextGrid"
...
# Save temporal file
selectObject: text$
Write to text file: directory$ + basename$ + "_mod2.TextGrid"
